describe("read_annot", {
  ...
  it("read_annotation throws an error for a malformed file", {
  ...
  it("successfully reads a valid file with colortable", {
    temp_file <- withr::local_tempfile(fileext = ".annot")
  ...
  it("reads actual FreeSurfer annotation file with colortable", {
  ...
  it("successfully reads a file without colortable", {
    temp_file <- withr::local_tempfile(fileext = ".annot")
  ...
  # Note: FreeSurfer test data may not have annotation files without colortable
  # it("reads actual FreeSurfer annotation file without colortable", {
  #   skip_if_no_freesurfer()
  #
  #   ant <- file.path(
  #     fs_subj_dir(),
  ...
  it("handles empty colortable labels correctly", {
    temp_file <- withr::local_tempfile(fileext = ".annot")
