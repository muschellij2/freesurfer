describe("fs_version", {
  it("works correctly when version file exists", {
  ...
  it("returns empty string and warns when version file does not exist", {
  ...
  it("handles an empty version file gracefully", {
  ...
  it("handles multi-line version files", {
