describe("read_fs_label", {
  ...
  it("reads a valid label file correctly", {
    ...
    it("reads actual FreeSurfer label file", {
  ...
  it("handles empty label file (minimum valid structure)", {
  ...
  it("warns if number of lines does not match specification", {
  ...
  it("throws error for non-existent file", {
    ...
    non_existent_file <- file.path(temp_dir, "non_existent.label")
    expect_error(
  ...
  it("handles leading/trailing spaces in lines", {
