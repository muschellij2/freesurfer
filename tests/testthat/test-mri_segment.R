describe("mri_segment", {
  it("calls fs_cmd with correct function name", {
    ...
    mri_segment(temp_file, outfile = out_file)

    expect_equal(captured_args$func, "mri_segment")
  ...
  it("passes frontopts from opts parameter", {
    ...
    mri_segment(temp_file, outfile = out_file, opts = "-wlo 80 -whi 125")

    expect_equal(captured_args$frontopts, "-wlo 80 -whi 125")
  })
  ...
  it("respects retimg parameter", {
    ...
    mri_segment(temp_file, outfile = out_file, retimg = FALSE)
...
describe("mri_segment.help", {
  it("calls fs_help with correct function name", {
    ...
    mri_segment.help()
    expect_equal(captured_func, "mri_segment")
  })
})
