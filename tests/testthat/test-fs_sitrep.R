describe("fs_sitrep", {
  ...
  it("alert_info correctly handles various scenarios", {
  ...
  it("alert_info provides expected warnings for default values", {
  ...
  it("returns early when FreeSurfer is not available", {
    local_fs_unset()
    local_mocked_bindings(
  ...
  it("handles unexpected mri_info output format", {
    local_fs_unset()
    local_mocked_bindings(
      have_fs = function() TRUE,
      get_fs_home = function(simplify) {
      ...
      get_fs_license = function(simplify, ...) {
        mock_fs_settings(value = "/mock/license.txt", source = "ENV", exists = TRUE)
      },
      get_fs_subdir = function(simplify, ...) {
        mock_fs_settings(
          value = "/mock/subjects",
  ...
  it("handles failed mri_info command", {
    local_fs_unset()
    local_mocked_bindings(
      have_fs = function() TRUE,
      get_fs_home = function(simplify) {
  ...
  it("skips command testing when test_commands = FALSE", {
    local_fs_unset()
    local_mocked_bindings(
      have_fs = function() TRUE,
      get_fs_home = function(simplify) {
  ...
  it("recommends setting home when fs_home is NA", {
    local_fs_unset()
    local_mocked_bindings(
      have_fs = function() TRUE,
      get_fs_home = function(simplify) {
